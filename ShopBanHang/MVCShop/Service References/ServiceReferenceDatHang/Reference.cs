...
namespace MVCShop.ServiceReferenceDatHang {
    ...
    public interface IServiceDatHang {
        ...
        MVCShop.ServiceReferenceDatHang.DonHang[] All();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/All", ReplyAction="http://tempuri.org/IServiceDatHang/AllResponse")]
        System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang[]> AllAsync();
        ...
        MVCShop.ServiceReferenceDatHang.DonHang[] DonHangTheoUser(string iduser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/DonHangTheoUser", ReplyAction="http://tempuri.org/IServiceDatHang/DonHangTheoUserResponse")]
        System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang[]> DonHangTheoUserAsync(string iduser);
        ...
        MVCShop.ServiceReferenceDatHang.DonHang[] TimTheoNgay(System.DateTime ngay);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/TimTheoNgay", ReplyAction="http://tempuri.org/IServiceDatHang/TimTheoNgayResponse")]
        System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang[]> TimTheoNgayAsync(System.DateTime ngay);
        ...
        MVCShop.ServiceReferenceDatHang.DonHang LayMaHD(string iduser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDatHang/LayMaHD", ReplyAction="http://tempuri.org/IServiceDatHang/LayMaHDResponse")]
        System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang> LayMaHDAsync(string iduser);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceDatHangChannel : MVCShop.ServiceReferenceDatHang.IServiceDatHang, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceDatHangClient : System.ServiceModel.ClientBase<MVCShop.ServiceReferenceDatHang.IServiceDatHang>, MVCShop.ServiceReferenceDatHang.IServiceDatHang {
        ...
        public MVCShop.ServiceReferenceDatHang.DonHang[] All() {
            return base.Channel.All();
        }
        
        public System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang[]> AllAsync() {
            return base.Channel.AllAsync();
        }
        
        public MVCShop.ServiceReferenceDatHang.DonHang[] DonHangTheoUser(string iduser) {
            return base.Channel.DonHangTheoUser(iduser);
        }
        
        public System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang[]> DonHangTheoUserAsync(string iduser) {
            return base.Channel.DonHangTheoUserAsync(iduser);
        }
        
        public MVCShop.ServiceReferenceDatHang.DonHang[] TimTheoNgay(System.DateTime ngay) {
            return base.Channel.TimTheoNgay(ngay);
        }
        
        public System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang[]> TimTheoNgayAsync(System.DateTime ngay) {
            return base.Channel.TimTheoNgayAsync(ngay);
        }
        
        public MVCShop.ServiceReferenceDatHang.DonHang LayMaHD(string iduser) {
            return base.Channel.LayMaHD(iduser);
        }
        
        public System.Threading.Tasks.Task<MVCShop.ServiceReferenceDatHang.DonHang> LayMaHDAsync(string iduser) {
